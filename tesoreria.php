                    ...
                    <div
                        ...
                        <div class="flex flex-wrap gap-4">
                            <?php foreach ($balances as $b): ?>
                                <div
                                    class="px-4 py-2 bg-slate-50 dark:bg-[#101822] border border-slate-100 dark:border-[#233348] rounded-xl flex items-center gap-3">
                                    <span
                                        class="material-symbols-outlined text-slate-400 text-sm">account_balance_wallet</span>
                                    <div>
                                        <p class="text-[9px] font-bold text-slate-500"><?php echo $b['payment_method']; ?>
                                        </p>
