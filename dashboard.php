                        ...
                        <div class="space-y-6">
                            ...
                            <div
                                ...
                                <h3 class="font-bold text-[#136dec] mb-2 uppercase text-xs tracking-widest">Acceso
                                    Directo</h3>
                                <p class="dark:text-white text-slate-700 text-sm font-medium mb-4">Consulta el
                                ...
                                <a href="productos.php"
                                    ...
                                    <span class="material-symbols-outlined text-lg">category</span> IR AL INVENTARIO
                                </a>
                            </div>
                        </div>
                    </div>
