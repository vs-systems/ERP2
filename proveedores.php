                    ...
                    <table>
                        ...
                        <tbody>
                            <?php foreach ($suppliers as $s): ?>
                                <tr style="<?php echo !$s['is_enabled'] ? 'opacity: 0.5' : ''; ?>">
                                    <td>
                                        <strong>
                                            <?php echo $s['name']; ?>
                                        </strong><br>
                                    ...
                                    <td>
                                        <?php echo $s['tax_id']; ?><br>
                                        <small>
                                            <?php echo $s['document_number']; ?>
                                        </small>
                                    </td>
                                    <td>
                                    ...
                                    <td><span class="badge"
                                            style="background: rgba(139, 92, 246, 0.2);"><?php echo $s['tax_category']; ?></span>
                                    </td>
                                    <td>
                                        <?php echo $s['email']; ?><br>
                                        <small>
                                    ...
                                    <td>
                                        <button class="btn-edit" onclick='editEntity(<?php echo json_encode($s); ?>)'>
