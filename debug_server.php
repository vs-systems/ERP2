...
echo "<h2>2. Testeando Configuración</h2>";
...
echo "<h2>3. Testeando Conexión BD</h2>";
try {
    $dsn = "mysql:host=" . DB_HOST . ";dbname=" . DB_NAME . ";charset=utf8mb4";
    $pdo = new PDO($dsn, DB_USER, DB_PASS);
    echo "<strong style='color:green'>Conexión Exitosa a la Base de Datos!</strong>";
} catch (PDOException $e) {
    echo "<strong style='color:red'>Error de Conexión: " . $e->getMessage() . "</strong>";
}
